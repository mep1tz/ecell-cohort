            ...
            <div class="container px-6 py-12 mx-auto">
                ...
                <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <a class="mt-2 text-blue-500 dark:text-blue-400 hover:text-blue-200" href="mailto:ecellsip23@gmail.com">ecellsip23@gmail.com</a>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-2 text-gray-500 dark:text-gray-400">Come say hello to us on LinkedIn</p>
                        <a class="mt-2 text-blue-500 dark:text-blue-400 hover:text-blue-200" href ="https://www.linkedin.com/company/ecellnitt/">Entrepreneurship Cell , NIT Trichy</a>
                    </div>
                    ...
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <a class="mt-2 text-blue-500 dark:text-blue-400 hover:text-blue-200" href="tel:+916382550051">Ajay- +91-6382550051</a>    
                        <a class="mt-2 text-blue-500 dark:text-blue-400 hover:text-blue-200" href="tel:+919025649457">Harshith- +91-9025649457</a>
